...
import { isAuthenticated, login, logout, status } from "./auth/index.js";
		...
		switch (command) {
			...
			case undefined:
				...
				if (!(await isAuthenticated())) {
					...
					console.log(
						chalk.white("You must authenticate before creating projects."),
					);
			...
			default:
				...
				console.log(
					chalk.white("Run 'mittvibes help' to see available commands.\n"),
				);
				process.exit(1);
		}
	} catch (error) {
